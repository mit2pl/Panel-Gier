...
<div style="height: 800px; position: relative;">
    ...
    @csrf
        ...
        <div class="logininput" style="margin-top: 20px;">
            <input id="email" type="email" name="email" value="{{ old('email') }}" class="inputseelogin" placeholder="Email" style="/*color: #c5c5c5;*/" required autocomplete="email" autofocus>
        </div>
        <div class="logininput" style="margin-top: 10px;margin-bottom: 20px;">
            <input  class="inputseelogin" id="password" type="password" name="password" style="margin-top: 20px;margin-bottom: 20px;" placeholder="Password" required autocomplete="current-password">
        </div>
        <div class="logininput" style="margin-top: 10px;margin-bottom: 20px;">
            <div class="text-center" style="/*margin-top: 10px;*//*display: block;*//*margin-bottom: -10px;*/"><label style="margin-top: 10px;color: #c5c5c5;"><input name="remember" id="remember" type="checkbox">&nbsp;{{ __('Remember Me') }}</label></div>
        </div>
        ...
        <div class="text-center"><a class="linka" href="{{ route('password.request') }}"><br>{{ __('Forgot Your Password?') }}<br><br></a></div>
        <div class="text-center" style="/*margin-top: 10px;*//*display: block;*//*margin-bottom: -10px;*/"><a class="linka" href="{{ route('register') }}">{{ __ ('Register')}}<br><br></a></div>
    </form>
    @if ($errors->any())
